package com.xupp.teststorage.storage;
...
public interface IStorage extends AutoCloseable {
     ...
     * @param file
     */
    boolean uploadFileToSpace(String space, String targetKey, File file, Map<String,String> options) throws IOException;
     ...
     * @return
     */
    Map<String,InputStream> zipDownload(String space, String refId);
